...
symlog_field_keys = ['flux', 'velocity_normal','J_cross_B_x','J_cross_B_y','J_cross_B_z','v_cross_B_x',  'O_p1_v_cross_B_z', ]
log_field_keys = ['number_density', 'temperature', 'magnetic_pressure', 'pressure','current_total', 'J_cross_B_total',
                   'magnetic_field_total', 'v_cross_B_total', 'O2_p1_v_cross_B_total', 'O_p1_v_cross_B_total',  'O_p1_velocity_total',
                   'O2_p1_v_-_fluid_v_total']
