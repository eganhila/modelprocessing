label_lookup = {'H_p1_number_density':r'$n(H+)$', #\;\mathrm{cm^{-3}}$',
          ...
          'batsrus_multi_species':'BATSRUS-MS',
          'batsrus_multi_fluid':'BATSRUS-MF',
          'batsrus_electron_pressure':"BATSRUS-Pe",
          'heliosares':'HELIOSARES',
          'total_flux':'$\mathrm{Total\; Ion\;Flux\; [\#/cm^2s]}$',
          'x':'x', 'y':'y', 'z':'z',
          ...
          'O_p1_v_cross_B_y':r'$(v(O+)\times B)_y$',
          'O_p1_v_cross_B_x':r'$(v(O+)\times B)_x$',
          'O_p1_v_cross_B_total':r'$|(v(O+)\times B)|$',
